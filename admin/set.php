...
';
	...
	<div class="">
		...
		<a class="btn btn-block btn-success" id="create_url">生成我的防毒链接</a>
	</div>
</div>
';
																					}
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<center><button class="btn btn-info btn-sm" id="recreate_url">重新生成</button>&nbsp;<button class="btn btn-warning btn-sm" id="copyurl" data-clipboard-text="">一键复制链接</button></center>
			</div>
...
';
																									...
																									else 
																									{
																										...
																										{
																											$faka_mail='<b>商品名称：</b> [name]<br/><b>购买时间：</b>[date]<br/><b>以下是你的卡密信息：</b><br/>[kmdata]<br/>----------<br/><b>使用说明：</b><br/>[alert]<br/>----------<br/>QQ代刷网自助下单平台<br/>[domain]';
																														...
																														else 
																														{
																															...
																															else 
																															{
																																if ($mod=='pay') 
																																{
																																	if (DIST_ID==13) 
																																	{
																																		$payadd='<option value="7">天乐易支付</option>';
																																	}
																																	else 
																																	{
																																		if (DIST_ID==34) 
																																		{
																																			$payadd='<option value="7">小纯洁易支付</option>';
																																		}
																																		else 
																																		{
																																			if (DIST_ID==35) 
																																			{
																																				$payadd='<option value="7">零九易支付</option>';
																																			}
																																			else 
																																			{
																																				if (DIST_ID==36) 
																																				{
																																					$payadd='<option value="7">920易支付</option>';
																																				}
																																				else 
																																				{
																																					if (DIST_ID==45) 
																																					{
																																						$payadd='<option value="7">淘淘易支付</option>';
																																					}
																																					else 
																																					{
																																						if (DIST_ID==49) 
																																						{
																																							$payadd='<option value="7">欢乐云支付</option>';
																																						}
																																						else 
																																						{
																																							if (DIST_ID==55) 
																																							{
																																								$payadd='<option value="7">爱支付</option>';
																																							}
																																							else 
																																							{
																																								if (DIST_ID==76) 
																																								{
																																									$payadd='<option value="7">52易支付</option>';
																																								}
																																								else 
																																								{
																																									if (DIST_ID==109) 
																																									{
																																										$payadd='<option value="7">行知云支付</option>';
																																									}
																																									else 
																																									{
																																										if (DIST_ID==122) 
																																										{
																																											$payadd='<option value="7">亿支付</option>';
																																										}
																																										else 
																																										{
																																											if (DIST_ID==127) 
																																											...
																																											else 
																																											{
																																												if (DIST_ID==151) 
																																												{
																																													$payadd='<option value="7">售乐云支付</option>';
																																												}
																																												else 
																																												{
																																													if (DIST_ID==182) 
																																													{
																																														$payadd='<option value="7">慧心云支付</option>';
																																													}
																																													else 
																																													{
																																														if (DIST_ID==153) 
																																														{
																																															$payadd='<option value="7">初梦云支付</option>';
																																														}
																																														else 
																																														{
																																															if (DIST_ID==188) 
																																															{
																																																$payadd='<option value="7">18易支付</option>';
																																															}
																																															else 
																																															{
																																																if (DIST_ID==202) 
																																																{
																																																	$payadd='<option value="7">九天易支付</option>';
																																																}
																																																else 
																																																{
																																																	if (DIST_ID==211) 
																																																	{
																																																		$payadd='<option value="7">乐讯易支付</option>';
																																																	}
																																																	else 
																																																	{
																																																		if (DIST_ID==231) 
																																																		{
																																																			$payadd='<option value="7">极速云支付</option>';
																																																		}
																																																		else 
																																																		{
																																																			if (DIST_ID==238) 
																																																			{
																																																				$payadd='<option value="7">文东易支付</option>';
																																																			}
																																																			else 
																																																			{
																																																				$payadd='';
...
<div class="">
 <form action="./set.php?mod=pay_n" method="post" class="form-horizontal" role="form"><input type="hidden" name="do" value="submit"/>
	<div class="form-group">
		...
		<div class="col-lg-8">
			<select class="form-control" name="alipay_api" default="';
																																	...
																																	echo '"><option value="0">关闭</option><option value="1">支付宝官方即时到账接口</option><option value="3">支付宝当面付扫码支付</option><option value="2">轻云支付免签约接口</option></select>
	...
	<div class="form-group">
		...
		<div class="col-lg-8">
			<select class="form-control" name="tenpay_api" default="';
																																	...
																																	echo '"><option value="0">关闭</option><option value="1">财付通官方支付接口</option><option value="2">轻云支付免签约接口</option></select>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-8">
			<select class="form-control" name="qqpay_api" default="';
																																	echo $conf['qqpay_api'];
																																	echo '"><option value="0">关闭</option><option value="1">QQ钱包官方支付接口</option><option value="2">轻云支付免签约接口</option></select>
	...
	<div class="form-group">
		...
		<div class="col-lg-8">
			<select class="form-control" name="wxpay_api" default="';
																																	echo $conf['wxpay_api'];
																																	echo '"><option value="0">关闭</option><option value="1">微信官方扫码+公众号支付接口</option><option value="3">微信官方扫码+H5支付接口</option><option value="2">轻云支付免签约接口</option></select>
	...
	';
																																	...
																																	{
																																		echo '	<div class="form-group">
		<label class="col-lg-3 control-label">轻云支付接入商</label>
		<div class="col-lg-8">
			<select class="form-control" name="payapi" default="';
																																		echo $conf['payapi'];
																																		echo '"><option value="0">轻云支付(副接口)</option>';
																																		echo $payadd;
																																	 echo '<option value="2">轻云支付(主接口)</option></select>
		</div>
	</div>
	<div class="form-group" id="payapi_07" style="';
																																		...
																																		echo '">
		<label class="col-lg-3 control-label">轻云支付接口网址</label>
		<div class="col-lg-8">
			<input type="text" name="epay_url" class="form-control"
				  value="';
																																		echo $conf['epay_url'];
																																		echo '" placeholder="http://pay.c7e.cn/">
		</div>
	</div>
	<div class="form-group">
		<label class="col-lg-3 control-label">轻云支付商户ID</label>
		<div class="col-lg-8">
	...
	<div class="form-group">
		<label class="col-lg-3 control-label">轻云支付商户密钥</label>
		<div class="col-lg-8">
	...
	';
																																	...
																																	echo '	<div class="form-group">
	 <div class="col-sm-offset-3 col-sm-8"><input type="submit" name="submit" value="修改" class="btn btn-primary form-control"/><br/><br/>
	 <a href="http://pay.c7e.cn/">免签支付注册及订单查询</a>
	</div>
	</div>
 </form>
</div>
																																...
																																else 
																																{
																																	...
																																	else 
																																	{
																																		if ($mod=='epay') 
																																		{
																																			...
																																			{
																																				showmsg('你还未填写轻云支付商户ID和密钥，请返回填写！');
																																			}
																																			...
																																			echo '<div class="block">
<div class="block-title"><h3 class="panel-title">轻云支付设置</h3></div>
<div class="">
<ul class="nav nav-tabs"><li class="active"><a href="#">轻云支付设置</a></li><li><a href="./set.php?mod=epay_order">订单记录</a></li><li><a href="./set.php?mod=epay_settle">结算记录</a></li></ul>
...
';
																																		...
																																		else 
																																		{
																																			if ($mod=='epay_settle') 
																																			{
																																				...
																																				echo '<div class="block"><div class="block-title w h"><h3 class="panel-title">轻云支付结算记录</h3></div>
         ...
         <tbody>';
																																			...
																																			else 
																																			{
																																				if ($mod=='epay_order') 
																																				{
																																					...
																																					echo '<div class="block"><div class="block-title"><h3 class="panel-title">轻云支付订单记录</h3></div>订单只展示前30条[<a href="set.php?mod=epay">返回</a>]
	<div class="table-responsive">
       <table class="table table-striped">
